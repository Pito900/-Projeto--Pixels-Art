# Boas vindas ao meu repositório do Projeto Pixels Art (Terceiro projeto da Trybe-TurmaXp)!

Este projeto foi voltado ao uso do DOM. Aqui no README.md estão todos os desafios, porém fui além a estilizei com CSS o projeto.
